...
PROJECT_SLUG = 'anno-docs-publish-addon'

# Project name to be used in file paths
PROJECT_FILENAME = 'anno_docs_publish_addon'

# The name of the repository containing the source
REPOSITORY_NAME = 'anno-docs-publish-addon'
...
GOOGLE APPS SCRIPTS
"""
GAS_PROJECT_NAME = 'AnnoDocsPublish' # Google app scripts addon project name
